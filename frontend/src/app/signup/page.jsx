...
export default function Signup() {
    ...
    const Sign = async (e) => {
        e.preventDefault();
        try {
            const { data } = await axios.post('http://localhost:8000/user', { email, password  , name , number});
    ...
    return (
        <>
            ...
            <div>
                <div className="flex justify-center py-14 rounded">
                    <div className="bg-[#EC4B9A]  w-[500px] h-[600px] rounded-l-3xl flex flex-col ">
                    ...
                    <form onSubmit={Sign}>
                        <div className="bg-[#f8f8f8] w-[500px] h-[600px] rounded-r-3xl flex flex-col justify-center items-center">
